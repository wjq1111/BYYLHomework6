...
# 序号	0	节点类型	程序开始					child:	1 4 7 10 13 23 
...
# 序号	13	节点类型	If语句					0child:	14 18 20 21 
# 序号	14	节点类型	运算		操作符	!		child:	15 
# 序号	15	节点类型	运算		操作符	!=		child:	16 17 
# 序号	16	节点类型	变量名	a				child:	
# 序号	17	节点类型	变量名	b				child:	
# 序号	18	节点类型	Prinf语句				child:	19 
# 序号	19	节点类型	常量		字符串	"Success\n"		child:	
# 序号	20	节点类型	Else语句				child:	
# 序号	21	节点类型	Prinf语句				child:	22 
# 序号	22	节点类型	常量		字符串	"Failed\n"		child:	
# 序号	23	节点类型	Return语句				child:	24 
# 序号	24	节点类型	常量		int10	0		child:	
